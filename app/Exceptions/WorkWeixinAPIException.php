...
class WorkWeixinAPIException extends BaseException
{
    private $error_messages = [
        ...
        740000 => '安全网关gateway_info的<host,port>冲突',
        740001 => '安全网关target_info的path冲突',
        740002 => '安全网关数量超过上限',
        740003 => '单个安全网关内的path数量超过限制',
        740004 => '安全网关不存在',
        740005 => '安全网关gateway_info的host非域名',
        740006 => '安全网关gateway_info的host验证失败',
        770001 => '高级功能额度不足',
    ...
    {
        $code = $this->getCode();
        Log::channel('workWeixinApi')->error('[error] - ' . date('Y-m-d H:i:s') . ' - ' . $code . ' - ' . $this->error_messages[$code] . '(' . $this->getMessage() . ')', $this->getPrimitives());
    }
}
